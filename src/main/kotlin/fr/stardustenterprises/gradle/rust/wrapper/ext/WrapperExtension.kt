...
abstract class WrapperExtension
    ...
    constructor(
        ...
        @Input
        val rustupCommand: Property<String> =
        ...
        private val cargoName: String by lazy {
            val cargoTomlFile =
                crate.file("Cargo.toml").orNull?.asFile
        ...
        private val defaultTargetOptions: TargetOptions by lazy {
        ...
        fun defaultTarget(): TargetOptions = defaultTargetOptions
